...
public class Phonebook {
    ...
    public static String FindSurname(String number){
        ...
        if (result == null) return "абонент не абонент, не найдете его, нет";
        return result;
    }
    public static String[] FindNumberPhone(String surname){
        ...
        if (result.size() == 0) result.add("Никого не нашли с такой фамилией");
    ...
    public static void main(String[] args) throws IOException {
        ...
        loadPB();
        PrintPhonebook();
        System.out.println("Выберите действие: add - добавить данные, del - удалить данные, num - найти номер по фамилии, sur - найти фамилию, " +
